...
urlpatterns = [
    ...
    # POST { "phone": "...", "password": "..." }
    # JWT payload contains is_ward_account flag — frontend branches on this.
    ...
    # provinces → districts?province=<id> → municipalities?district=<id>
    #           → wards?municipality=<id>
    # -----------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------
    # Issues — citizen facing (public read, auth required to post)
    # -----------------------------------------------------------------------
    path('issues/',        IssueListCreateView.as_view(),  name='issue-list-create'),
    path('issues/<int:pk>/', IssueDetailView.as_view(),   name='issue-detail'),

    # -----------------------------------------------------------------------
    # Ward dashboard — ward accounts only
    # -----------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------
    # Public ward posts feed & ranking
    # -----------------------------------------------------------------------
    ...
    # -----------------------------------------------------------------------
    # Reports  (target_type: 'issue' | 'comment')
    # Use reason='false_resolution' to re-flag a falsely completed issue.
    # -----------------------------------------------------------------------
